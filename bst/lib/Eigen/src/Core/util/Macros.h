...
#define EIGEN_XTENSA_WORLD_VERSION 2
#define EIGEN_XTENSA_MAJOR_VERSION 1
#define EIGEN_XTENSA_MINOR_VERSION 0
...
#if !defined(EIGEN_COMP_XTENSA)
  #if defined(__XTENSA__)
    #define EIGEN_COMP_XTENSA 1
  #else
    #define EIGEN_COMP_XTENSA 0
  #endif
#endif

#ifndef EIGEN_USE_XTENSA_PKTMATH
  #if EIGEN_COMP_XTENSA
    #define EIGEN_USE_XTENSA_PKTMATH 1
  #else
    #define EIGEN_USE_XTENSA_PKTMATH 0
  #endif
#endif

#ifndef EIGEN_USE_XTENSA_DSPLIB
  #define EIGEN_USE_XTENSA_DSPLIB 0
#endif
...
#if EIGEN_COMP_XTENSA && EIGEN_USE_XTENSA_PKTMATH
  #include <xtensa/config/core-isa.h>
  #if XCHAL_HAVE_BBENEP
    #include <xtensa/tie/xt_bben.h>
    #define SIMD_WIDTH XCHAL_BBEN_SIMD_WIDTH
    #define EIGEN_HAVE_SP_VFPU XCHAL_HAVE_CONNX_B_SP_VFPU
    #define EIGEN_HAVE_DP_VFPU XCHAL_HAVE_CONNX_B_DP_VFPU
  #elif XCHAL_HAVE_VISION
    #include <xtensa/tie/xt_ivpn.h>
    #define SIMD_WIDTH XCHAL_IVPN_SIMD_WIDTH
    #include "Eigen/src/Core/arch/xtensa/xt_bben.h"
    #define EIGEN_HAVE_SP_VFPU XCHAL_HAVE_VISION_SP_VFPU
    #define EIGEN_HAVE_DP_VFPU XCHAL_HAVE_VISION_DP_VFPU
  #elif XCHAL_HAVE_HIFI5
    #if XCHAL_HW_VERSION >= 281090
      #define XCHAL_HAVE_HIFI5_3 1
    #else
      #define XCHAL_HAVE_HIFI5_3 0
    #endif
    #include <xtensa/tie/xt_hifi5.h>
    #if XCHAL_HAVE_HIFI5_3
      #define SIMD_WIDTH 8 // Using xtfloatx4 for HIFI5_3
    #else
      #define SIMD_WIDTH 4 // Using xtfloatx2 for HIFI5
    #endif
    #define EIGEN_HAVE_SP_VFPU XCHAL_HAVE_HIFI5_VFPU
    #define EIGEN_HAVE_DP_VFPU 0 //In HiFi5 DP VFPU is not define
  #elif XCHAL_HAVE_HIFI3Z
    #include <xtensa/tie/xt_hifi3.h>
    #define SIMD_WIDTH 4 // Using xtfloatx2 for HIFI3Z
    #define EIGEN_HAVE_SP_VFPU XCHAL_HAVE_HIFI3Z_VFPU
    #define EIGEN_HAVE_DP_VFPU 0 //In HiFi3z DP VFPU is not define
  #elif XCHAL_HAVE_HIFI1
    #if XCHAL_HW_VERSION >= 281090
      #define XCHAL_HAVE_HIFI1_1 1
    #endif
    #include <xtensa/tie/xt_hifi3.h>
    #define SIMD_WIDTH 4 // Using xtfloatx2 for HIFI1
    #define EIGEN_HAVE_SP_VFPU XCHAL_HAVE_HIFI1_VFPU
    #define EIGEN_HAVE_DP_VFPU 0 //In HiFi1 DP VFPU is not define
  #elif XCHAL_HAVE_PDX
    #include <xtensa/tie/xt_pdxn.h>
    #define SIMD_WIDTH XCHAL_PDXN_SIMD_WIDTH
    #include "Eigen/src/Core/arch/xtensa/xt_bben.h"
    #define EIGEN_HAVE_SP_VFPU XCHAL_HAVE_FUSIONG_SP_VFPU
    #define EIGEN_HAVE_DP_VFPU XCHAL_HAVE_FUSIONG_DP_VFPU
  #elif XCHAL_HAVE_FP
    #define EIGEN_HAVE_VFPU 0
    #define EIGEN_HAVE_SP_VFPU 0
    #define EIGEN_HAVE_DP_VFPU 0
  #else
    #error "DSP_CORE is not supported"
  #endif

  #ifndef XCHAL_HAVE_HIFI5_3
    #define XCHAL_HAVE_HIFI5_3 0
  #endif
  #ifndef XCHAL_HAVE_HIFI1_1
    #define XCHAL_HAVE_HIFI1_1 0
  #endif

  #if !EIGEN_HAVE_SP_VFPU
    #undef EIGEN_USE_XTENSA_PKTMATH
    #define EIGEN_USE_XTENSA_PKTMATH 0
    #pragma message("DSP_CORE doesn't support VFPU. Thus disabling PKTMATH.")
  #endif

  #if EIGEN_USE_XTENSA_PKTMATH
  #define SIMD_N SIMD_WIDTH
  #define SIMD_N_2 (SIMD_N / 2)
  #define SIMD_N_4 (SIMD_N / 4)
  #define SIMD_N_8 (SIMD_N / 8)
  #define SIMD_N_16 (SIMD_N / 16)
  #define SIMD_N_32 (SIMD_N / 32)
  #define SIMD_2N (2 * SIMD_N)
  #endif
#endif

#if (EIGEN_USE_XTENSA_DSPLIB) && (EIGEN_USE_XTENSA_PKTMATH==0)
  #undef EIGEN_USE_XTENSA_DSPLIB
  #define EIGEN_USE_XTENSA_DSPLIB 0
  #pragma message("Xtensa DSPLIB can be used only when PKTMATH is enabled. Disabling DSPLIB")
#endif
