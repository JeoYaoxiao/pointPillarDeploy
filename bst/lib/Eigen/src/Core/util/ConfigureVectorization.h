...
#if defined(EIGEN_SSE2_ON_MSVC_2008_OR_LATER)
#undef EIGEN_SSE2_ON_MSVC_2008_OR_LATER
#endif // defined(EIGEN_SSE2_ON_MSVC_2008_OR_LATER)
#if defined(EIGEN_SSE2_ON_NON_MSVC_BUT_NOT_OLD_GCC)
#undef EIGEN_SSE2_ON_NON_MSVC_BUT_NOT_OLD_GCC
#endif // defined(EIGEN_SSE2_ON_NON_MSVC_BUT_NOT_OLD_GCC)
#endif
...
#elif EIGEN_COMP_XTENSA && EIGEN_USE_XTENSA_PKTMATH
#define EIGEN_VECTORIZE
#define EIGEN_VECTORIZE_XTENSA
...
inline static const char *SimdInstructionSetsInUse(void) {
  ...
  return "MIPS MSA";
#elif defined(EIGEN_VECTORIZE_XTENSA)
  return "XTENSA";
#else
  return "None";
#endif
